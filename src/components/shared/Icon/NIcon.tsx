...
const NIcon = ({ str }: { str: string }): JSX.Element => (
  <span className="wmnds-n-icon" style={{ display: 'inline-block' }}>
    <Icon
      ...
      description="A hexagon with the letter 'n' inside of it."
    />
    {str}
  </span>
);

export const ReplaceTextWithIcon = ({ htmlElement, classNames }: NIconsProps): JSX.Element => {
  ...
  const replacePhraseInHTML = (htmlEle: string, phrase: string): string => {
...
ReplaceTextWithIcon.defaultProps = defaultProps;
